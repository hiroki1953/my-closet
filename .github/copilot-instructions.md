...
- [ ] ログイン/ログアウト
- [ ] プロフィール設定（身長、体重、好みのスタイル等）

#### 2.1.2 クローゼット機能

- [ ] 服の写真アップロード
- [ ] 服の基本情報登録（カテゴリ、色、ブランド、購入時期）
- [ ] 服の一覧表示
- [ ] 服の編集・削除

#### 2.1.3 コーディネート提案機能

- [ ] うーちゃん（管理者）による手動コーディネート作成
- [ ] コーディネート画像の生成（服の組み合わせ表示）
- [ ] コーディネートコメント機能
- [ ] 着回しアドバイス
...
- [ ] ユーザー一覧・管理機能
- [ ] ユーザー別クローゼット確認機能
- [ ] 服のアイテム評価機能（必要/不要/キープ）
- [ ] アイテムへのコメント機能
- [ ] コーディネート作成ツール
- [ ] コーディネートへのスタイリングコメント機能
- [ ] 着こなしアドバイス機能
...
- **画像ストレージ**: Supabase Storage / Cloudinary
